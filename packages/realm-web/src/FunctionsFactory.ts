...
export class FunctionFactory {
    ...
    constructor(fetcher: Fetcher, serviceName?: string) {
    ...
    callFunction(name: string, ...args: any[]): Promise<any> {
        ...
        return this.fetcher.post("/functions/call", body);
    }
}
 ...
 */
export function create<FF extends Realm.FunctionFactory>(fetcher: Fetcher, serviceName?: string): FF {
    ...
    const factory = new FunctionFactory(fetcher, serviceName);
